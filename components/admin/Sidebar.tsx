...
export default function Sidebar({ isCollapsed, toggleSidebar }: SidebarProps) {
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                {isCollapsed ? (
                    <span style={{ fontSize: '24px', fontWeight: 'bold', letterSpacing: '2px' }}>
                        E<span style={{ color: '#c0e81b' }}>.</span>
                    </span>
                ) : (
                    <span style={{ fontSize: '24px', fontWeight: 'bold', letterSpacing: '2px' }}>
            ...
            <nav style={{
                flex: 1,
                padding: isCollapsed ? '0 10px' : '0 25px',
                overflowY: 'auto',
                overflowX: 'hidden',
                ...
                <Link href="/admin" style={linkStyle("/admin")}>
                    <svg style={{ marginRight: isCollapsed ? '0' : '15px', minWidth: '20px' }} width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
